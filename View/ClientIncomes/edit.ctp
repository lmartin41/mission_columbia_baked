...
<?php echo $this->Form->create('ClientIncome'); ?>
	<fieldset>
		<legend><?php echo __('Edit Client Income'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ClientIncome.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ClientIncome.id'))); ?></li>
