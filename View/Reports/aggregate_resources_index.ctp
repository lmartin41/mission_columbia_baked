...
<div class="Reports form">
    ...
    <h3>Aggregate Resources Report</h3><br />
    <?php $oldDate = Date('Y') . "-01-01"; ?>

    <form name="aggregateResource" method="post">

        Date:<input name="startDate" id="datepickAggResource" default="test" class="date-pick" style="width: 100px;" value = '<?php echo $oldDate; ?>' />
        &nbsp;
        <br /><br /><br />

        <script type="text/javascript">
            new datepickr('datepickAggResource', { dateFormat: 'Y-m-d' });
        </script>
        ...
        <input type="submit" value="Retrieve Aggregate Resource Report"/>
    </form>
