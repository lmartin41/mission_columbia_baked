...
<div class="reports form">
    ...
    <div id="chart_div"><?php $this->GoogleChart->createJsChart($chartTotal); ?></div>
    ...
    Total Number of Resource Usages (Family Units): <?php echo $countParticularFamilyUnits; ?><br />
    Total Number of Resource Usages (Singles): <?php echo $countParticularSingles; ?><br />
    Total Number of Clients Served: <?php echo $countParticularSingles + $countParticularFamilyUnits; ?><br />
