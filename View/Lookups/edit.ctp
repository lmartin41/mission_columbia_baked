...
<div class="actionsNoButton">
    <?php echo $this->Form->postLink(__('Delete Label'), array('action' => 'delete', $this->Form->value('Lookup.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lookup.id'))); ?><br />
