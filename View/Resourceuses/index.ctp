<div class="resourceuses index">
	<h2><?php echo __('Resource Uses'); ?></h2>
	...
	<tr>
		<td><?php echo h($resourceus['Resourceus']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($resourceus['Resourceus']['created']); ?>&nbsp;</td>
		<td><?php echo h($resourceus['Resourceus']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $resourceus['Resourceus']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $resourceus['Resourceus']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $resourceus['Resourceus']['id']), null, __('Are you sure you want to delete # %s?', $resourceus['Resourceus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
