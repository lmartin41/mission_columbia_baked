<div class="clientChecklists index">
    <h2><?php echo __('Client Checklists'); ?></h2>
    <table cellpadding="0" cellspacing="0">
        ...
        foreach ($clientChecklists as $clientChecklist):
            if ($clientChecklist['ClientChecklist']['client_id'] == $clientID):
                ?>
                <tr>
        ...
        <?php echo $this->Html->link($clientChecklist['Client']['id'], array('controller' => 'clients', 'action' => 'view', $clientChecklist['Client']['id'])); ?>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), array('action' => 'view', $clientChecklist['ClientChecklist']['id'])); ?>
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $clientChecklist['ClientChecklist']['id'])); ?>
        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clientChecklist['ClientChecklist']['id']), null, __('Are you sure you want to delete # %s?', $clientChecklist['ClientChecklist']['id'])); ?>
                    </td>
                </tr>
            <?php endif; ?>
<?php endforeach; ?>
...
<div class="actionsNoButton">
        ...
        <?php echo $this->Html->link(__('Create a new Client Checklist'), array('action' => 'add')); ?><br /><br />
